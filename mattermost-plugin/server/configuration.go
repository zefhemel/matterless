...
func (p *Plugin) OnConfigurationChange() error {
	...
	p.container.ClusterEventBus().SubscribeContainerLogs(func(appName, funcName, message string) {
		//mlog.Info(fmt.Sprintf("[%s | %s] %s", appName, funcName, message))
		p.API.LogInfo(fmt.Sprintf("[%s | %s] %s", appName, funcName, message))
	})
